...
function onCliclAppMenu(link)
{
	$.post(link,"",function(resp)
	{
		$("#appActionDiv").html(resp);
		$(".editActionLink").colorbox({transition:"fade",
			onLoad: function() 
			{
				$('#cboxPrevious').remove();
				$('#cboxNext').remove();
...
function message(msg)
{
	...
	if(arguments[2])
	{
		h=',height:"'+arguments[2]+'"';
	}
	if(arguments[3])
	{
		l=',iframe:true, href:"'+arguments[3]+'"';
	}
	var str = 'var parm = {html:msg'+w+h+l+',onComplete:function(){initColorbox("colorbox");initScrollbar();disable_scroll();},onClosed:function(){enable_scroll();}}';
	eval(str);
...
function showLink(link)
{
	...
	var str = 'var parm = {'+l+i+w+h+',onComplete:function(){initColorbox("colorbox");initScrollbar();disable_scroll();'+callback+'},onClosed:function(){enable_scroll();}}';
	eval(str);
	$.colorbox(parm);
}
function ajax(url,parm,fun)
{
	if(arguments[3]!=true)
	{
		SC.lock("Loading...");
...
function initColorbox(className)
{
	$("."+className).colorbox({transition:"fade",
	onLoad: function()
	{
	$('#cboxPrevious').remove();
	$('#cboxNext').remove();
